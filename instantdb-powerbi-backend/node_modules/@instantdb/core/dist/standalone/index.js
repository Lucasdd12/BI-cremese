...
function dt(t, e, n, r) {
  ...
  s && (s.callbacks || (s.callbacks = []), s.callbacks.push((i, o) => {
    ...
    if (G(B(c, e), n)) {
      let u = s.original;
      s.copy && (u = s.copy), ze(t), Ve(t, r, i, o), t.options.enableAutoFreeze && (t.options.updatedValues = (a = t.options.updatedValues) !== null && a !== void 0 ? a : /* @__PURE__ */ new WeakMap(), t.options.updatedValues.set(u, s.original)), ye(c, e, u);
    }
...
const ve = (t, e, n = !1) => {
  ...
  set(t, e) {
    ...
    return (!r.has(t) || !G(r.get(t), e)) && ($(n), Q(n), n.assignedMap.set(t, !0), n.copy.set(t, e), dt(n, t, e, he)), this;
  },
  delete(t) {
    if (!this.has(t))
      return !1;
...
}, sr = Reflect.ownKeys(Qe), vt = (t, e, { isValuesIterator: n }) => () => {
  var r, s;
  const i = e.next();
  if (i.done)
    return i;
  ...
  add(t) {
    const e = A(this);
    return this.has(t) || ($(e), Q(e), e.assignedMap.set(t, !0), e.setMap.set(t, t), dt(e, t, t, he)), this;
  },
  delete(t) {
    if (!this.has(t))
      return !1;
...
const ir = Reflect.ownKeys(ke), an = /* @__PURE__ */ new WeakSet(), cn = {
  ...
  set(t, e, n) {
    ...
    return a && G(a.original, n) ? (t.copy[e] = n, t.assignedMap = (r = t.assignedMap) !== null && r !== void 0 ? r : /* @__PURE__ */ new Map(), t.assignedMap.set(e, !1), !0) : (G(n, o) && (n !== void 0 || le(t.original, e)) || ($(t), Q(t), le(t.original, e) && G(n, t.original[e]) ? t.assignedMap.delete(e) : t.assignedMap.set(e, !0), t.copy[e] = n, dt(t, e, n, he)), !0);
  },
  has(t, e) {
    return e in N(t);
  },
...
function ft(t) {
  ...
  if (s.revoke.push(u), an.add(c), a.proxy = c, n) {
    ...
    l.finalities.draft.push((d, f) => {
      ...
      if (b) {
        let T = b.original;
        b.operated && (T = ut(_)), ze(b), Ve(b, he, d, f), l.options.enableAutoFreeze && (l.options.updatedValues = (p = l.options.updatedValues) !== null && p !== void 0 ? p : /* @__PURE__ */ new WeakMap(), l.options.updatedValues.set(T, b.original)), ye(w, r, T);
      }
...
function or(t, e, n, r, s) {
  ...
  return o && qe(o), s && ee(u, u, o == null ? void 0 : o.options.updatedValues), [
    u,
...
function ar(t, e) {
  ...
  let s, i;
  e.enablePatches && (s = [], i = []);
  const a = ((n = e.mark) === null || n === void 0 ? void 0 : n.call(e, t, F)) === F.mutable || !z(t, e) ? t : ft({
    original: t,
    parentDraft: null,
    finalities: r,
    options: e
...
function un(t) {
  ...
  let s;
  function i() {
    s = r === 2 ? ct(t) ? new Map(t) : new (Object.getPrototypeOf(t)).constructor(t) : r === 3 ? Array.from(n.setMap.values()) : sn(t, n == null ? void 0 : n.options);
  }
  if (n) {
    n.finalized = !0;
    try {
...
const cr = (t) => function e(n, r, s) {
  ...
  const d = Y(c) ? kt(c) : c, f = Array.isArray(l.mark) ? (m, v) => {
  ...
  const S = (m) => {
    ...
    if (!Y(m)) {
      ...
      if (L) {
        const Re = L[0];
        return w.strict && typeof m == "object" && m !== null && We({
          rootDraft: v,
          value: m,
          useRawReturn: !0
        }), b([Re]);
      ...
      if (m !== void 0)
        return typeof m == "object" && m !== null && We({ rootDraft: v, value: m }), b([m]);
    }
    if (m === _ || m === void 0)
      return b([]);
    const O = A(m);
...
function hn(t, e, n) {
  ...
  for (const o of e) {
    ...
    l["checked-data-type"] === "date" && n && (u = Ce(u), o[2] = u), pt(l) && R(i, [u, c, a], o), R(r, [a, c, u], o), R(s, [c, a, u], o);
  }
...
function gn(t, e, n) {
  ...
  a && (q(t.eav, [s, i, o]), q(t.aev, [i, s, o]), pt(a) && q(t.vae, [o, i, s]));
}
let Cr = 0;
function _n(t, e, n) {
  const [r, s, i] = n;
...
function wn(t, e, n) {
  ...
  Ir(a) ? (R(t.eav, [s, i], /* @__PURE__ */ new Map([[o, l]])), R(t.aev, [i, s], /* @__PURE__ */ new Map([[o, l]]))) : (R(t.eav, [s, i, o], l), R(t.aev, [i, s, o], l)), pt(a) && R(t.vae, [o, i, s], l);
}
function Pr(t, e, n) {
  var p;
  const r = be(t, n);
...
function Be(t, e, n) {
  ...
  if (a) {
    for (const d of a.keys()) {
      ...
      f && f["on-delete-reverse"] === "cascade" && x(a.get(d), 1).forEach(
        ([p, y, g]) => {
          var w;
          return Be(t, e, [g, (w = f["reverse-identity"]) == null ? void 0 : w[1]]);
        }
  ...
  c && c.forEach((d) => {
    ...
    (!s || !g || ((w = g["reverse-identity"]) == null ? void 0 : w[1]) === s) && (q(t.eav, [f, p, y]), q(t.aev, [p, f, y]), q(t.vae, [y, p, f])), g && g["on-delete"] === "cascade" && ((_ = g["reverse-identity"]) == null ? void 0 : _[1]) === s && Be(t, e, [f, (b = g["forward-identity"]) == null ? void 0 : b[1]]);
...
function Hr(t, e, n) {
  return e.or ? e.or.patterns.flatMap((r) => He(t, r, n)) : e.and ? e.and.patterns.reduce((r, s) => He(t, s, r), n) : n.flatMap((r) => Br(t, e, r));
}
function He(t, e, n = [{}]) {
...
function ms(t, e, n, r) {
  const s = Pe;
  return r ? vn(s, t, e, n, r).concat($t(s, t, e, n)) : $t(s, t, e, n);
}
function Ss(t, e, n) {
...
function ks(t, e, n, r) {
  ...
  const [u, l] = r, d = e["checked-data-type"], f = d === "date" ? Ye(l) : l, p = d === "date" ? Ye(o) : o;
...
function zs(t, e, n) {
  if (!qs(t, e, n))
    return M(t, e, n);
  const r = Xe(n), s = M(t, e, r) || X(t, e, r);
...
function Gs(t, e) {
  const { attrsStore: n } = t, [r, s, i, o] = e, a = ht(i), c = U(n, r, s);
...
function Bs(t, e) {
  const { attrsStore: n } = t, [r, s, i, o] = e, a = ht(i), c = U(n, r, s), u = Pn(t, [r, c, i, o]);
...
function Js(t, e) {
  const { attrsStore: n } = t, [r, s, i, o] = e, a = ht(i), c = U(n, r, s), u = Pn(t, [r, c, i, o]), l = Object.entries(a).map(([f, p]) => {
    const y = M(n, r, f);
    return [
      "deep-merge-triple",
      c,
    ...
    return new Promise((n, r) => {
      ...
      i.onerror = (o) => {
        ...
        if (s) {
          ...
          Ft.set(this.dbName, u), u.then(() => n(c)).catch(() => n(c));
        } else {
          const u = Ft.get(this.dbName);
...
function Pi(t, e) {
  if (t.isLoading !== e.isLoading || t.error !== e.error || (t.user || e.user) && (!t.user || !e.user || !Et(t.user, e.user)) || !ln(t.peers, e.peers)) return !0;
...
}, Gt = (t) => typeof t != "string" ? !1 : Me(t) ? !0 : re(t);
class K extends Error {
  constructor(e) {
...
class Ji {
  constructor(e, n, r, s, i, o) {
    ...
    h(this, "createStore");
    h(this, "getAttrs");
    this.trySend = e, this.config = r, this.log = s, this.createStore = i, this.getAttrs = o, this.subs = new nt({
      persister: n,
      merge: Qi,
      serialize: Vi,
    ...
    switch (Zt[n.op] || this._log.info("[receive]", e, n.op, n), n.op) {
      ...
      case "add-query-ok": {
        ...
        if (!this._hasQueryListeners() && !this.querySubs.currentValue[y])
          break;
        const g = (a = (o = p == null ? void 0 : p[0]) == null ? void 0 : o.data) == null ? void 0 : a["page-info"], w = (u = (c = p == null ? void 0 : p[0]) == null ? void 0 : c.data) == null ? void 0 : u.aggregate, _ = Vt(p), b = this.ensureAttrs(), T = te(
          b,
          _,
          r,
          this.config.useDateObjects
      ...
      case "refresh-ok": {
        ...
        const w = Xt(g.entries()), _ = f.map((b) => {
          var wt, Tt, mt, St;
          const T = b["instaql-query"], S = b["instaql-result"], m = C(T), v = Vt(S), O = this.ensureAttrs(), L = te(
            O,
            v,
            r,
            this.config.useDateObjects
...
`,
  ...
  queryOnce(e, n) {
    this.config.disableValidation || Wt(e, this.config.schema), n && "ruleParams" in n && (e = { $$ruleParams: n.ruleParams, ...e });
    const r = new zt();
    if (!this._isOnline)
      return r.reject(
...
function mo(t) {
  return `${_t || Rn ? "http://localhost:3000" : "https://instantdb.com"}/_devtool?appId=${t}`;
}
function So(t) {
  ...
  constructor(e) {
    ...
    h(this, "completeIsomorphic", (e, n, r, s) => {
      ...
      const o = !!((f = (d = (l = this.db) == null ? void 0 : l._reactor) == null ? void 0 : d.config) != null && f.schema) && ("cardinalityInference" in ((y = (p = this.db) == null ? void 0 : p._reactor) == null ? void 0 : y.config) ? !!((w = (g = this.db) == null ? void 0 : g._reactor.config) != null && w.cardinalityInference) : !0), a = new H(
        ...
        rt((_ = this.db) == null ? void 0 : _._reactor.config.schema)
      ), c = te(
        a,
        n,
        o,
